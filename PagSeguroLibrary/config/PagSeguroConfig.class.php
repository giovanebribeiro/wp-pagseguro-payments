...
class PagSeguroConfig
{
    ...
    /********* ADICIONADO POR: Giovane Boaviagem **********/
    public static function setEnvironment($env){
        if(strcmp($env,"production")||strcmp($env,"sandbox")){
            self::$data['environment']=$env;
        }else{
            throw new Exception("Environment not set. Only 'sandbox' and 'production' options are allowed.");
        }
    }
    /******************************************************/
